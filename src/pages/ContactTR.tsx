...
function ContactTR() {
  ...
  return (
    <>
      <Helmet>
        <title>İletişim - Mehmet Reşit Gül</title>
        <meta name="description" content="AI otomasyon projeleri, n8n iş akışı geliştirme ve e-ticaret verimlilik çözümleri için Mehmet Reşit Gül ile iletişime geçin. İş birliğine açık." />
      </Helmet>
