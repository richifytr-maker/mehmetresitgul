...
function ExperienceTR() {
  ...
  return (
    <>
      <Helmet>
        <title>Deneyim - Mehmet Reşit Gül</title>
        <meta name="description" content="Projeler ve deneyimler: Takazade startup, AI otomasyon geliştirme, n8n iş akışları, ürün geliştirme ve yapay zeka destekli karar verme üzerine nörobilim araştırmaları." />
      </Helmet>
