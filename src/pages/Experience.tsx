...
function Experience() {
  ...
  return (
    <>
      <Helmet>
        <title>Experience - Mehmet Resit Gul</title>
        <meta name="description" content="Projects and experience: Takazade startup, AI automation development, n8n workflows, product development, and neuroscience research on AI-assisted decision making." />
      </Helmet>
